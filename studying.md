...
![](media/image3.png){width="2.3168886701662292in"
height="2.0764566929133856in"}![](media/image1.png){width="2.338542213473316in"
height="2.0683103674540684in"}
...
![](media/image2.png){width="3.009555993000875in"
height="1.6347583114610673in"}![](media/image6.png){width="2.9218755468066493in"
height="1.4900590551181103in"}
...
![](media/image5.png){width="2.836023622047244in"
height="1.1574365704286964in"}
...
![](media/image4.png){width="2.4843755468066493in"
height="1.2766929133858267in"}
...
+-------------------------+---------------+--------------------+
| activation(활성화 함수) | 은닉층+입력층 | relu               |
+=========================+===============+====================+
|                         | 은닉층        | relu               |
+-------------------------+---------------+--------------------+
|                         | 출력층        | sigmoid            |
